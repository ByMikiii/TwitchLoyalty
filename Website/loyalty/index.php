...
<h1 id="message"
  class="absolute left-1/2 -translate-x-1/2 top-16 text-green-600 text-<?php echo $_SESSION['color'] ?>-600">
...
<?php if($item['active'] == 1): ?>
  <div class="item relative w-60 h-80 border border-redpink-100 rounded-md text-white mx-6 my-4 p-2">
    ...
    <div class="mt-4 mb-0 flex">
      <button class='bg-redpink-100 text-darkblue-100 py-0.5 px-1 rounded-md hover:brightness-125 w-24'>
        <a href="<?php if(isset($_SESSION['username'])){ echo './scripts/redeemScript.php?item='.$item['name'];}?>">
          <div class="flex ml-auto">
            <svg class="svg-icon w-6 ml-auto mr-1" viewBox="0 0 20 20">
            ...
            <h1 class="text-lg mr-auto"><?php echo $item['price']?></h1>
          </div>
        </a></button>
