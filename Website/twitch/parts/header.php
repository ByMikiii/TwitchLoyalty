...
if(!isset($_SESSION)){
  ...
  require_once($_SERVER['DOCUMENT_ROOT'] . '/twitch/scripts/getCurrentUser.php');
...
<head>
  ...
  <link href="/twitch/dist/output.css" rel="stylesheet">
...
<body class='bg-darkblue-100'>
  <div
    ...
    <button class='text-gray-900 bg-redpink-100 p-1.5 font-semibold rounded-md hover:brightness-110 ml-auto items-end'>
      <a
        href="https://id.twitch.tv/oauth2/authorize?response_type=code&client_id=pl88xj79ewii5nqmb51lnokicqo1ri&redirect_uri=http://localhost/twitch/redirect.php&scope=channel%3Amanage%3Apolls+channel%3Aread%3Apolls&state=c3ab8aa609ea11e793ae92361f002671">Login
  ...
  elseif(isset($_SESSION['username'])): ?>
    ...
    <div class="dropdown inline-block relative ml-auto items-end">
      <a id='username' class='text-redpink-100 font-bold text-lg relative p-2 py-3' href="/twitch/profile/"> <?php 
